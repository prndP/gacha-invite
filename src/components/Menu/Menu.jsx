require('./MenuBackgroudAnimation');
	...
	render() {
		return (
				<div>
					...
					<div className="Menu-AnimationContainer" ref={(thisRef)=>{this.anim_container = thisRef}} style={this.containerStyle}>
						<canvas width={this.canvasWidth} height={this.canvasHeight} ref={(thisRef)=>{this.canvas = thisRef}} style={this.canvasStyle}></canvas>
						<div ref={(thisRef)=>{this.dom_overlay_container = thisRef}} style={this.domOverlayStyle}>
						</div>
					</div>
				</div>
		);
